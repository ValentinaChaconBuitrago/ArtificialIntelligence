...
\fref{fig:ai-categorization} shows the existing \ac{ML} approaches and their relations. Each of these 
...
This paper offers an introductory overview of the field of \ac{ML}, presenting the necessary 
background for its main representative techniques, namely, \ac{SML}, and \ac{NN} (\fref{sec:related}). 
...
requirements to apply the corresponding technique (\fref{sec:validation}). For the development of the 
