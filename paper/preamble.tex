...
\lstdefinestyle{tensorflow}
 {language=Python,
  ...
  tabsize=3,
  style=floating,
  morekeywords={with, as, tf, pd, lambda, DataFrame}
}

%tensorflow environment    
\lstnewenvironment{tensorflow}[1][]
 {\lstset{style=tensorflow,#1}}{}  


 % tensorflow in line source-code
\newcommand{\tensorcode}[1]{\textrm{\texttt{#1}}}
\def\tensorcode{\lstinline[style=tensorflow]}
